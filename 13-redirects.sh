...
# these both send files/linex.txt to wc's stdin
wc < files/lines.txt
cat files/lines.txt | wc

# people say it's bad to use 'cat' when yo udon't need to
# because it's wasteful / unnnecessary but I usually do it
